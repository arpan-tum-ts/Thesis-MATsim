package abm.scenarios.autonomousAccessibility.runner;
...
import abm.scenarios.autonomousAccessibility.ModelSetupAutonomousAccessibility;
...
public class RunAbitAutonomousAccessibility {

    static Logger logger = Logger.getLogger(RunAbitAutonomousAccessibility.class);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ModelSetup modelSetup = new ModelSetupAutonomousAccessibility(dataSet);
